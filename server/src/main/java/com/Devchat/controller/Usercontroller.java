...
public class Usercontroller {
    ...
    // The @RequestBody annotation binds the incoming JSON to the UserRegistrationDTO object
    ...
    // The ResponseEntity class represents the entire HTTP response, including status code and body
    @GetMapping("/{id}")
    ...
    // Accepts a user ID as a path variable and a JSON payload containing updated user details
    // The @PutMapping annotation specifies that this method handles PUT requests
    // The @RequestBody annotation binds the incoming JSON to the UserUpdateDTO object
    @PutMapping("/{id}")
    ...
    // The @DeleteMapping annotation specifies that this method handles DELETE requests
    // The ResponseEntity class represents the entire HTTP response, including status code and body
    @DeleteMapping("/{id}")
